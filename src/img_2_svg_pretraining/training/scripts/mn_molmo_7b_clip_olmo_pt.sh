...
#SBATCH --job-name=mn_molmo_7b_clip_olmo_pt
#SBATCH --nodes=2
...
#SBATCH --exclusive
#SBATCH --output=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_molmo_7b_clip_olmo_pt_%j.out
#SBATCH --error=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_molmo_7b_clip_olmo_pt_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/mn_molmo_7b_clip_olmo_pt.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/mn_molmo_7b_clip_olmo_pt_rank_\${NODE_RANK}.log
"
'

echo "Job mn_molmo_7b_clip_olmo_pt completed."
