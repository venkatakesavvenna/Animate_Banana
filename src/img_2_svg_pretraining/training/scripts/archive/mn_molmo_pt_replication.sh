...
#SBATCH --job-name=training_molmo_pt_replication
#SBATCH --nodes=2
...
#SBATCH --exclusive
#SBATCH --output=../src/logs/slurm_molmo_pt_replication_%j.out
#SBATCH --error=../src/logs/slurm_molmo_pt_replication_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/mn_molmo_pt_replication.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/molmo_pt_replication_rank_\${NODE_RANK}.log
"
'

echo "Molmo PT replication job completed."
