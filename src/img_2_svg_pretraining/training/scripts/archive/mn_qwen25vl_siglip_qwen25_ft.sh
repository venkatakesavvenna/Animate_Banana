...
#SBATCH --job-name=mn_qwen25vl_siglip_qwen25_ft
#SBATCH --nodes=2
...
#SBATCH --exclusive
#SBATCH --output=../src/logs/slurm_mn_qwen25vl_siglip_qwen25_ft_%j.out
#SBATCH --error=../src/logs/slurm_mn_qwen25vl_siglip_qwen25_ft_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/mn_qwen25vl_siglip_qwen25_ft.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/mn_qwen25vl_siglip_qwen25_ft_rank_\${NODE_RANK}.log
"
'

echo "Job mn_qwen25vl_siglip_qwen25_ft completed."
