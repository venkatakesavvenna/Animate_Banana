...
#SBATCH --job-name=mn_qwen25vl_siglip_qwen25_pt
#SBATCH --nodes=2
#SBATCH --nodelist=ip-10-20-241-38,ip-10-20-233-75
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:8
#SBATCH --cpus-per-task=64
#SBATCH --mem-per-cpu=4G
#SBATCH --exclusive
#SBATCH --output=../src/logs/slurm_mn_qwen25vl_siglip_qwen25_pt_%j.out
#SBATCH --error=../src/logs/slurm_mn_qwen25vl_siglip_qwen25_pt_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/mn_qwen25vl_siglip_qwen25_pt.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/mn_qwen25vl_siglip_qwen25_pt_rank_\${NODE_RANK}.log
"
'

echo "Job mn_qwen25vl_siglip_qwen25_pt completed."
