...
#SBATCH --job-name=mn_qwen25vl_3b_veclip_raw_pt
#SBATCH --nodes=2
...
#SBATCH --output=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_qwen25vl_3b_veclip_raw_pt_%j.out
#SBATCH --error=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_qwen25vl_3b_veclip_raw_pt_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/encoder_swap/mn_qwen25vl_3b_veclip_raw_pt.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/mn_qwen25vl_3b_veclip_raw_pt_rank_\${NODE_RANK}.log
"
'

echo "Job mn_qwen25vl_3b_veclip_raw_pt completed."
