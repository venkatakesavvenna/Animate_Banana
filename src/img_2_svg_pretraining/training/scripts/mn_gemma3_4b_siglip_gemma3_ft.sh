...
#SBATCH --job-name=mn_gemma3_4b_siglip_gemma3_ft
#SBATCH --nodes=2
...
#SBATCH --exclusive
#SBATCH --output=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_gemma3_4b_siglip_gemma3_ft_%j.out
#SBATCH --error=/fsxvision_new/venkat.kesav/img_2_svg_pretraining/src/img_2_svg_pretraining/training/logs/slurm_mn_gemma3_4b_siglip_gemma3_ft_%j.err
...
TRAINING_CONFIG="${TRAINING_CONFIG:-/code/src/img_2_svg_pretraining/training/configs/mn_gemma3_4b_siglip_gemma3_ft.yaml}"
...
torchrun \
  ...
  2>&1 | tee logs/mn_gemma3_4b_siglip_gemma3_ft_rank_\${NODE_RANK}.log
"
'

echo "Job mn_gemma3_4b_siglip_gemma3_ft completed."
