"""okvqa — HuggingFaceM4/OK-VQA outside knowledge visual question answering dataset.
...
@DatasetRegistry.register_dataset("okvqa")
def get_okvqa_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
