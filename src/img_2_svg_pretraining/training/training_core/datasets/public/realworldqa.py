"""realworldqa — xai-org/RealworldQA real-world visual question answering dataset.

Registry key: realworldqa
...
@DatasetRegistry.register_dataset("realworldqa")
def get_realworldqa_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
