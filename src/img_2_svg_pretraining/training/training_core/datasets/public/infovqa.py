"""infovqa — HuggingFaceM4/InfographicVQA infographic visual question answering dataset.

Registry key: infovqa
"""
...
HUB_ID = "HuggingFaceM4/InfographicVQA"
...
def get_source(
    ...
    source_dict = {
        ...
        "conversations": [
            {
                "from": "human",
                "value": f"<image>\nAnswer the question about the infographic: {question}",
            },
...
@DatasetRegistry.register_dataset("infovqa")
def get_infovqa_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
