"""chartqa — HuggingFaceM4/ChartQA chart question answering dataset.

Registry key: chartqa
"""
...
def get_source(
    ...
    source_dict = {
        ...
        "conversations": [
            {
                "from": "human",
                "value": f"<image>\nAnswer the following question about the chart: {query}",
            },
...
@DatasetRegistry.register_dataset("chartqa")
def get_chartqa_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
    ...
    **dataset_specific_kwargs,
    ...
    try:
        ...
        # Fall back to test split if validation is missing
        ds = _load_split(HUB_ID, "test", streaming, sample_limit)
