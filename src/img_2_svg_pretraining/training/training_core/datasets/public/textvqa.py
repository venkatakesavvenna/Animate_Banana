"""textvqa — facebook/textvqa text-based visual question answering dataset.

Registry key: textvqa
"""
...
@DatasetRegistry.register_dataset("textvqa")
def get_textvqa_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
