"""vqa2 — HuggingFaceM4/VQAv2 visual question answering v2 dataset.
...
def get_source(
    ...
    answer = source.get("multiple_choice_answer") or ""
...
@DatasetRegistry.register_dataset("vqa2")
def get_vqa2_dataargs(
    get_sam_source_fn,
    seed=42,
    sam_image_size=1024,
    train=True,
